...
import { jsonResponse, toMCPResponse, errorResponse, handleError } from "./utils/response";
...
async function listProducts(args: any, env: Env) {
  // TODO: Implementar en Tarea 4.2
  return errorResponse("not_implemented", "La herramienta list_products aún no está implementada.");
}
